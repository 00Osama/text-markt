...
class S {
  ...
  String get signOutAndResetPassword {
    return Intl.message(
      'Please sign out and reset your Password',
      name: 'signOutAndResetPassword',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Pin Setup`
  String get pinSetup {
    return Intl.message('Pin Setup', name: 'pinSetup', desc: '', args: []);
  }
  ...
  String get resetEmailSentSuccessfully {
    return Intl.message(
      'Password reset email sent successfully',
      name: 'resetEmailSentSuccessfully',
      desc: '',
      args: [],
    );
  }
  ...
  String get noteSuccessfullyMovedTo {
    return Intl.message(
      'Note successfully moved to',
      name: 'noteSuccessfullyMovedTo',
      desc: '',
      args: [],
    );
  }
  ...
  String get saveQueryToSearchHistory {
    return Intl.message(
      'Save query to search history',
      name: 'saveQueryToSearchHistory',
      desc: '',
      args: [],
    );
  }
  ...
  String get clearQueryAndExit {
    return Intl.message(
      'Clear query and exit',
      name: 'clearQueryAndExit',
      desc: '',
      args: [],
    );
  }
